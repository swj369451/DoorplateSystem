package com.example.doorplatesystem.webrtc;
...
public class SignalingClient {
    ...
    public void init(Callback callback,String identification) {
        ...
        try {
            ...
            socket.on("connect", args -> {
                Log.i("SignalingClient", "socket连接成功");
                socket.emit("login",identification);
            });
            socket.on("logined", args -> {
                Log.i("SignalingClient", "登录成功");
            });
            ...
            socket.on("message", args -> {
                ...
                if(arg instanceof String) {
                    ...
                    if("offer".equals(type)) {
                        ...
                        callback.onDisconnect(data.optString("from"));
                    }
                }
            });
